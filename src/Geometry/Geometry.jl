...
export ElementaryEntity, Domain,
    ...
    IMT, Duffy, GeometricTransformation, type_tag_to_etype, bounding_box, HyperRectangle, center, diameter, radius, line, triangle, rectangle, extrude, translate, ParametricLine, AbstractReferenceShape
